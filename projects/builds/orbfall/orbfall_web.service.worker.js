...
/** @type {string} */
const CACHE_VERSION = '1779894302|154842140';
/** @type {string} */
const CACHE_PREFIX = 'OrbFall-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'orbfall_web.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["orbfall_web.html","orbfall_web.js","orbfall_web.offline.html","orbfall_web.icon.png","orbfall_web.apple-touch-icon.png","orbfall_web.audio.worklet.js","orbfall_web.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["orbfall_web.wasm","orbfall_web.pck"];
